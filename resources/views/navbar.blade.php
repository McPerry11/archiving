<nav style="height:100px" >
  <div class="nav-wrapper">
    ...
    <div style="position:absolute;top:5px;right:5px;height:55px">
      ...
      <img src="{{ asset('img/logo/ue.png') }}" alt="" height="53px">
    ...
    <ul id="nav-mobile" class="right" style="margin-top:60px;height:40px">
      ...
      @endif
      <li><a class="dropdown-trigger" href="#!" data-target="dropdown1">Hi, {{ Auth::user()->username }}<i class="material-icons right">arrow_drop_down</i></a></li>
    </ul>
  </div>
</nav>
